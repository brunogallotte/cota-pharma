      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6">
            Pronto para Transformar Seus Negócios?
          </h2>

          <p className="text-xl text-primary-foreground/90 mb-8 leading-relaxed">
            Junte-se a milhares de fornecedores e farmácias que já estão
            crescendo conosco. Comece gratuitamente hoje mesmo.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              size="lg"
              className="bg-card text-foreground hover:bg-card/90 shadow-xl text-base"
            >
